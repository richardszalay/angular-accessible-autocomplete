...
describe("rszAutocomplete", function() {
	beforeEach(module('rszAutocomplete'));
	...
	describe('when list completion is enabled', function() {
		...
		describe('and the input is changes but is less than the minimum length', function() {
			...
			beforeEach(inject(function() {
				...
				compileDirective('<input type="text" rsz-autocomplete="suggestions" autocomplete-minimum="3" />', $scope);
		...
		describe('and input changes', function() {
			describe('and a previous delay has not elapsed', function() {
				beforeEach(function() {
					...
					compileDirective('<input type="text" rsz-autocomplete="suggestions" autocomplete-minimum="0" />', $scope);
					enterText('abc');
				});
		...
		describe('when the enter key is pressed', function() {
			describe('and there is a selected suggestion', function() {
				beforeEach(function() {
					...
					compileDirective('<input type="text" rsz-autocomplete="suggestions" accessible-autocomplete-selected="onSelected" />', $scope);
