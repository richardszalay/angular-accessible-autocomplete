(function() {
	...
	function accessibleAutocompleteDirective($compile, accessibleAutocomplete, accessibleAutocompleteKeyProcessor) {
		...
		return {
			...
			link: function(scope, element, attrs) {
				...
				//scope.options.suggestionsSelector = scope.$eval(attrs.accessibleAutocomplete);
