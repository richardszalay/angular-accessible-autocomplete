(function() {
	...
	var accessibleAutocompleteDirective = ['$http', '$compile', '$templateCache', '$q', 'accessibleAutocomplete', 'accessibleAutocompleteKeyProcessor', 
								  function ($http, $compile, $templateCache, $q, accessibleAutocomplete, accessibleAutocompleteKeyProcessor) {
