(function() {
	...
	function accessibleAutocompleteProvider() {
		var defaultOptions = {
	...
	function accessibleAutocompleteDirective($http, $compile, $templateCache, $q, accessibleAutocomplete, accessibleAutocompleteKeyProcessor) {
	...
	function accessibleAutocompleteKeyProcessor() {
		return {
	...
	function accessibleAutocompleteController($scope, accessibleSerialTimeout, accessibleSerialPromise, accessibleAutocomplete) {
		$scope.options = angular.extend({}, accessibleAutocomplete);

		$scope.options.templateUrl = $scope.templateUrl || $scope.options.templateUrl;

		$scope.options.minimumLength = $scope.minimumLength ? $scope.minimumLength() : $scope.options.minimumLength;
	...
	function accessibleSerialTimeout($timeout) {
		return function() {
	...
	function accessibleSerialPromise($q) {
		return function() {
